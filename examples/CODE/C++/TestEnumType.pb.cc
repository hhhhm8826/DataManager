...
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_TestEnumType_2eproto = {
    ...
    TableStruct_TestEnumType_2eproto::offsets,
    file_level_enum_descriptors_TestEnumType_2eproto,
    file_level_service_descriptors_TestEnumType_2eproto,
};
namespace DATA_MANAGER_TABLE {
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ [[maybe_unused]] =
        (::_pbi::AddDescriptors(&descriptor_table_TestEnumType_2eproto),
         ::std::false_type{});
